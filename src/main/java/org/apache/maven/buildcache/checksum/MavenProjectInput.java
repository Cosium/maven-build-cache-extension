...
public class MavenProjectInput {
     ...
     */
    public static final String CACHE_IMPLEMENTATION_VERSION = "v1.2.1.cosium";
    ...
    public ProjectsInputInfo calculateChecksum(Zone zone) throws IOException {
        ...
        if (config.isBaselineDiffEnabled()) {
            baselineHolder = remoteCache
                    .findBaselineBuild(project, zone)
                    .map(b -> b.getDto().getProjectsInputInfo());
        }
